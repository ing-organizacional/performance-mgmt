/**
 * Evaluations Translation Types
 * 
 * Defines translation types for the performance evaluation system,
 * including evaluation forms, rating scales, progress tracking, and
