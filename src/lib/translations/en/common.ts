...
export const common: CommonTranslations = {
  ...
  aiRefinedTextSuccess: 'AI refined text successfully',
  aiFailedToImproveText: 'Failed to improve text',
  aiUnexpectedError: 'Unexpected error occurred. Please try again.',
