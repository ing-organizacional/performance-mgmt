...
export const users: UsersTranslations = {
  ...
  archiveEmployeeDescription: 'This will archive {name} and preserve their complete evaluation history. They will be removed from active operations but can be restored if needed.',
  archiveReasonPlaceholder: 'Optional reason for archiving (e.g., \'Employee resigned\', \'End of contract\', etc.)',
  archiveReasonNote: 'This reason will be saved for audit purposes and can help with future reference.',
  archiving: 'Archiving...',
  ...
  cannotArchiveManager: 'Cannot archive manager',
  activeEmployees: 'active employees',
  noDataCanBeDeleted: 'No evaluation data - safe to delete permanently',
