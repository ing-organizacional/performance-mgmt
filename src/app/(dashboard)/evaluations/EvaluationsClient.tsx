          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2 ml-3">
              <button
                ...
                className="flex items-center justify-center w-9 h-9 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 active:scale-95 transition-all duration-150 touch-manipulation"
              ...
              className="flex items-center justify-center w-9 h-9 bg-red-500 text-white rounded-lg hover:bg-red-600 active:scale-95 transition-all duration-150 touch-manipulation"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center justify-center space-x-1 px-2 py-2 bg-primary/10 text-primary text-xs font-medium rounded-lg hover:bg-primary/20 active:scale-95 transition-all duration-150 touch-manipulation whitespace-nowrap tracking-tighter leading-none"
              >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="text-center">
              <div className="text-xl font-bold text-amber-600">{teamSummary.pendingEvaluations}</div>
          ...
          <div className="mt-3 pt-3 border-t border-gray-200">
            <div className="flex justify-between text-xs">
              <span className="text-green-600 flex items-center gap-1"><CheckCircle className="w-3 h-3" /> {teamSummary.completedEvaluations}</span>
              <span className="text-amber-600 flex items-center gap-1">
                <RotateCcw className="w-3 h-3" />
                {teamSummary.inProgressEvaluations}
              </span>
              <span className="text-gray-500 flex items-center gap-1"><Circle className="w-3 h-3" /> {teamSummary.totalEmployees - teamSummary.completedEvaluations - teamSummary.inProgressEvaluations}</span>
            </div>
          </div>
        </div>
      </div>
