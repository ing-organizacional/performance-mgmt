          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2 flex-1">
              ...
              <button
                ...
                className="hidden md:flex items-center justify-center space-x-1 px-3 py-2 bg-primary text-white text-xs font-medium rounded-lg hover:bg-primary/90 active:scale-95 transition-all duration-150 touch-manipulation whitespace-nowrap"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
