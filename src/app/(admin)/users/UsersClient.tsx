          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500">Manage company users and permissions</p>
              </div>
            </div>
            <button
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500">
                        <span className="flex items-center gap-1">
                          ...
                          {user._count.employees} reports
                        </span>
                        <span className="flex items-center gap-1">
                          <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                          {user._count.evaluationsReceived} evaluations
                        </span>
                      </div>
                    </div>
                  </div>
      ...
      {showUserForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <form action={handleFormSubmit} className="px-6 py-4 space-y-4">
              <div>
          ...
          <div className="bg-white rounded-lg max-w-md w-full">
            ...
            <div className="px-6 py-4">
              <p className="text-gray-600">
                Are you sure you want to delete <strong>{showDeleteConfirm.user.name}</strong>? 
